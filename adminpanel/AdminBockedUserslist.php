                    ...
                    <div class="content">
                        ...
                        <div class="content-2">
                            <div class="recent-payments">
                                <div class="title">
                                    <h2>Posts</h2>
                                    <a href="/Final/adminpanel/viewallstoriesAdmin.php" class="">View All</a>
                                    <a href="/Final/adminpanel/bannedPostList.php" class="">Blocked Posts</a>
                                </div>
                                ...
                                <div class="" style="overflow: auto;height: 450px;">
                                    <table>
                                        <tbody>
                                            ...
                                            <?php
                                            include 'C:\xampp\htdocs\Final\db_connect.php';
                                            $postsSql="SELECT * FROM `bloglist` where `isAllowed`='1'";
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="/Final/adminpanel/viewallstoriesindetailAdmin.php?data=<?php echo $blogid ?>"
                                                        class="btn">View</a></td>
                                                <td><a href="/Final/adminpanel/deletestoryAdmin.php?data=<?php echo $blogid ?>"
                                                        class="btn">Block</a></td>
                                            </tr>
                                            <?php
                                        }
                                    }
                            ...
                            <div class="new-students">s
                                <div class="title">
                                    <h2>Users</h2>
                                    <a href="admin.php" class="">Admin Panel</a>
                                </div>
                                <table style="margin: 0;">
                                    <tbody>
                                        <tr>
                                ...
                                <div class="list" style="overflow: auto;height: 450px;">
                                    <table class="userInfo">
                                        <?php
                                            include 'C:\xampp\htdocs\Final\db_connect.php';
                                            $usersSql="SELECT * FROM `userinfo` WHERE `isAllowed`='0'";
                                        ...
                                        <tr>
                                            ...
                                            <td class="userName"><?php echo $rowsuser['UserId']?></td>
                                            <td>
                                                <a href="/Final/adminpanel/RestoreUser.php?data=<?php echo $rowsuser['UserId'] ?>"
                                                    class="btn">unblock
                                                </a>
                                                </ion-icon>
                                            </td>
