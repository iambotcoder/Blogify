                    ...
                    <div class="content">
                        <div class="cards">
                            <div class="card">
                                <div class="box" style="border: none;">
                                    ...
                                    $userSql="SELECT * FROM `userinfo` WHERE `isAllowed`='1'";
                        ...
                        <div class="content-2">
                            ...
                            <div class="new-students">
                                <div class="title">
                                    <h2>Users</h2>
                                    <a href="/Final/adminpanel/AdminBockedUserslist.php" class="">Blocked Users</a>
                                </div>
                                <table style="margin: 0;">
                                    <tbody>
                                        <tr>
                                ...
                                <div class="list" style="overflow: auto;height: 450px;">
                                    <table class="userInfo">
                                        <?php
                                            include 'C:\xampp\htdocs\Final\db_connect.php';
                                            $usersSql="SELECT * FROM `userinfo` WHERE `isAllowed`='1'";
