                        ...
                        <div class="profile_right__col">
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="likedpost.php">Liked Posts</a></li>
                                    <li><a href="dislikepost.php">DisLiked Posts</a></li>
                                    <li><a href="bannedpost.php" class="profile_active">Banned Posts</a></li>
                                </ul>
                            ...
                            <div class="profile_photos">
                                ...
                                $finalSql="SELECT * FROM `bloglist` WHERE `UserId`='$userid' AND `isAllowed`=0;";
                                $resfinalSql=mysqli_query($conn,$finalSql);
                                while($rowfinalSql=mysqli_fetch_assoc($resfinalSql)){
                                    $blog_id = $rowfinalSql['Blog_id'];
