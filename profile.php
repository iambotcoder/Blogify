                            ...
                            <div class="profile_photos">
                                ...
                                <?php echo " 
                                            <div class='story$blog_id'>
                                                <div class='grid-div'>
                                                <a href='#'><strong>$blog_heading </strong></a>
                                                <div class='buttons'>
                                                        <a href='fetchPostDetails.php?blogid=$blog_id' class='newBtn'> Modify </a>
                                                        <a href='delete.php?blogid=$blog_id' class='newBtn'> Delete </a>
                                                </div>
                                                    <a href='#'><span class='image main'>
                                                    <img src=' $blog_img '>
                                                    </span>
                                                    </a> 
                                                </div>
